...
function previewdistance(){
  ...
  var straightlinelenght = convertdistance(getstraightlinelenght, {originaldistanceunit: 'm', newdistanceunit: 'km'}).toFixed(2);
...
function pathFinder(){
  ...
  var path = findPath(pathFinder, startpoint, endpoint);
  console.log(path);
